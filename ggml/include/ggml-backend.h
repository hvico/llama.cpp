...
extern "C" {
    ...
    */
    ...
    // number of times the scheduler had to reallocate its compute buffers (each one synchronizes all backends)
    GGML_API size_t               ggml_backend_sched_get_n_reallocs(ggml_backend_sched_t sched);
